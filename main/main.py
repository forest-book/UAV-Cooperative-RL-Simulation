        ...
        for loop in range(self.loop_amount):
            ...
            for uav_i in self.uavs:
                for neighbor_id in uav_i.neighbors:
                    ...
                    # ノイズ付き観測値を取得
                    noisy_v, noisy_d, noisy_d_dot = self.get_noisy_measurements(uav_i, neighbor_uav, False, True, False)
            ...
            for uav_i in self.uavs:
                ...
                # ノイズ付き相対速度 v_ij を取得
                noisy_v_ij, _, _ = self.get_noisy_measurements(uav_i, target_j_uav, False, True, False)
